...
class CharBertEmbeddings(nn.Module):
    ...
    def forward(self, char_input_ids, start_ids, end_ids):
        ...
        char_input_ids_reshape = torch.reshape(
            char_input_ids, (batch_size, char_maxlen))
        ...
        start_one_hot = nn.functional.one_hot(
            start_ids, num_classes=char_maxlen)
...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        embeddings = inputs_embeds + position_embeddings + \
            token_type_embeddings  # + char_embeddings
...
class CharBertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, is_roberta=False):
        ...
        self.char_embeddings = CharBertEmbeddings(
            config, is_roberta=is_roberta)
    ...
    def forward(self, char_input_ids=None, start_ids=None, end_ids=None, input_ids=None, attention_mask=None,
        ...
        char_embeddings = self.char_embeddings(
            char_input_ids, start_ids, end_ids)
        ...
        outputs = (sequence_output, pooled_output, char_sequence_output, char_pooled_output) + \
            char_encoder_outputs[1:]  # add hidden_states and attentions if they are here
...
class CharBertForQuestionAnswering(BertPreTrainedModel):
    ...
    def forward(self, char_input_ids=None, start_ids=None, end_ids=None, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        sequence_output = torch.cat(
            (sequence_repr, char_sequence_repr), dim=-1)
...
class CharBertForMaskedLM(BertPreTrainedModel):
    ...
    def forward(self, char_input_ids=None, start_ids=None, end_ids=None, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        prediction_scores, term_scores = self.cls(
            sequence_repr, char_sequence_repr)

        # Add hidden states and attention if they are here
        outputs = (prediction_scores, term_scores) + outputs[3:]
        ...
        if adv_labels is not None:
            ...
            adv_term_loss = loss_fct(
                term_scores.view(-1, term_vocab_size), adv_labels.view(-1))
