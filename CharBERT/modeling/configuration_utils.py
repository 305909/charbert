...
class PretrainedConfig(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.output_past = kwargs.pop(
            'output_past', True)  # Not used by all models
        ...
        self.label2id = kwargs.pop('label2id', dict(
            zip(self.id2label.values(), self.id2label.keys())))
        self.label2id = dict((key, int(value))
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        print(
            f'pretrained_model_name_or_path: {pretrained_model_name_or_path}')
        print(
            f'cls.pretrained_config_archive_map: {cls.pretrained_config_archive_map}')
